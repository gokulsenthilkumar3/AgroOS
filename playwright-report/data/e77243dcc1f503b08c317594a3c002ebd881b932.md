...
Locator: getByText('QA rain plan desktop', { exact: true })
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText('QA rain plan desktop', { exact: true }) with timeout 5000ms
  - waiting for getByText('QA rain plan desktop', { exact: true })
...
- main:
  ...
  - button "Close":
    - img
  - text: Title
  - textbox "Title": QA rain plan desktop
  - text: Details
